...
* [compilers/interpreter_lambda](compilers/interpreter_lambda) : This example shows how to implement the untyped lambda calculus in a big-step semantics setting. That is, as an interpreter using an environment and closures. The example is an extension of `compilers/interpreter_arith_let`.
